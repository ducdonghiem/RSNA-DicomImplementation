...
def main():
    ...
    fold_results = trainer.train_with_kfold(csv_path, data_root, k_folds=5, resume=False)   # set resume=True to continue the training (with all the files in output_dir)
